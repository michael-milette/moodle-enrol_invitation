 ...
 *
 * This page allows the current user to edit a invitation user enrolment.
...
require_capability("enrol/invitation:manage", get_context_instance(CONTEXT_COURSE, $course->id, MUST_EXIST));
