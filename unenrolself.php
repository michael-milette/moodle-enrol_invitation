...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'invitation'), '*', MUST_EXIST);
...
require_capability("enrol/invitation:unenrolself", context_course::instance($course->id, MUST_EXIST));
...
$PAGE->set_url('/enrol/invitation/unenrolself.php', array('enrolid'=>$instance->id));
